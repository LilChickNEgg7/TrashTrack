...
namespace Capstone
{
    public partial class AM_AccountSettings : System.Web.UI.Page
    {
        ...
        protected void changepassword_Click(object sender, EventArgs e)
        {
            ...
            using (var db = new NpgsqlConnection(con))
            {
                ...
                try
                {
                    ...
                    {
                        cmdSelect.Parameters.AddWithValue("@adminId", amId);
                        ...
                        if (storedPassword == hashedCurrentPassword)
                        {
                            ...
                            using (var cmdUpdate = new NpgsqlCommand(updateQuery, db))
                            {
                                ...
                                cmdUpdate.Parameters.AddWithValue("@adminId", amId);
